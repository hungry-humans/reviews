  ...
  <div className="user-info-container">
    ...
    <div className="user-box-2">
      <div className="bold-text">
        <a href="#" className="username-anchor">{review.abbrname}</a>
      </div>
      <div className="bold-text">{review.location}</div>
      <div>
        ...
        <span className="bold-text"> {review.friends_count}</span> friends
      </div>
      <div>
        <span className="svg-image">
        ...
        <span className="bold-text"> {review.reviews_count}</span> reviews
      </div>
      <div>
        <span className="svg-image">
        ...
        <span className="bold-text"> {review.photos_count}</span> photos
      </div>
